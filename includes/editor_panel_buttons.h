...
void			create_sky_toggle_btn(TTF_Font *font, SDL_Surface *target,
					t_editor *ed, int *y);
...
void	        create_pickable_in_sector(t_editor *ed, int mouse_x,
					int mouse_y);
...
void			width_btn(t_editor *ed, TTF_Font *font, SDL_Surface *target,
					int *y);
void			height_btn(t_editor *ed, TTF_Font *font, SDL_Surface *target,
					int *y);
void			z_btn(t_editor *ed, TTF_Font *font, SDL_Surface *target,
					int *y);
void			remove_btn(t_editor *ed, TTF_Font *font, SDL_Surface *target,
					int *y);
