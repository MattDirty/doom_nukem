...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/19 11:03:52 by lfatton           #+#    #+#             */
/*   Updated: 2019/04/19 11:07:45 by lfatton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static enum e_bool	line_through_segment_intersects_point(t_segment segment,
		double x, double y)
{
	double				slope;
