...
t_map *create_map(t_textures *textures)
{
	...
	if (!(map->sectors->items =
				  (t_sector **) malloc(
						  map->sectors->count * sizeof(t_sector * ))))
	...
	while (i < map->sectors->count)
	{
		if (!(map->sectors->items[i]->walls = (t_walls *) malloc(
				sizeof(t_walls))))
			error_doom("t_walls");

		find_texture_by_name(textures, "textures/flats/grass.bmp",
							 &map->sectors->items[i]->floor);
		find_texture_by_name(textures, "textures/flats/dirt.bmp",
							 &map->sectors->items[i]->ceil);
		map->sectors->items[i]->open_sky = e_false;
		map->sectors->items[2]->open_sky = e_true;
		map->sectors->items[i]->objects = (t_objects *) malloc(
				sizeof(t_objects));
		...
		find_texture_by_name(textures, "textures/sprites/voilaunefleur.bmp",
							 &map->sectors->items[i]->objects->items[0].sprite);
		...
		find_texture_by_name(textures, "textures/sprites/voilaunefleur.bmp",
							 &map->sectors->items[i]->objects->items[1].sprite);
		find_texture_by_name(textures, "textures/sprites/voilaunefleur.bmp",
							 &map->sectors->items[i]->objects->items[2].sprite);

		map->sectors->items[i]->enemies = (t_linked_enemies *) malloc(
				sizeof(t_linked_enemies));
		...
		map->sectors->items[i]->pickables = (t_pickables *) malloc(
				sizeof(t_pickables));
		map->sectors->items[i]->pickables->next = NULL;

		map->sectors->items[i]->pickables->item.type = et_gun;
		map->sectors->items[i]->pickables->item.object = (t_object *) malloc(
				sizeof(t_object));
		...
		if (i == 2)
		{
			find_texture_by_name(textures, "textures/sprites/blackhole.bmp",
								 &map->sectors->items[i]->enemies->item.front);
			map->sectors->items[i]->enemies->item.object->sprite =
					map->sectors->items[i]->enemies->item.front;
			find_texture_by_name(textures, "textures/sprites/blackhole.bmp",
		...
		if (!(walls->items = (t_wall **) malloc(
				walls->count * sizeof(t_wall * ))))
		...
		while (j < walls->count)
		{
			...
			if (i == 1)
				...
				find_texture_by_name(textures, "textures/walls/brickwall2.bmp",
									 &walls->items[j]->texture);
			j++;
		}
		if (i == 0)
	...
	find_texture_by_name(textures, "textures/hud/health/ico1.bmp",
						 &map->hud.cross[0]);
	find_texture_by_name(textures, "textures/hud/health/ico2.bmp",
						 &map->hud.cross[1]);
	find_texture_by_name(textures, "textures/hud/health/ico3.bmp",
						 &map->hud.cross[2]);
	find_texture_by_name(textures, "textures/hud/bullet.bmp", &map->hud.bullet);
	find_texture_by_name(textures, "textures/hud/faces/happy.bmp",
						 &map->hud.happy_face);
	find_texture_by_name(textures, "textures/hud/faces/meh.bmp",
						 &map->hud.meh_face);
	find_texture_by_name(textures, "textures/hud/faces/sad.bmp",
						 &map->hud.sad_face);
	find_texture_by_name(textures, "textures/hud/faces/dead.bmp",
						 &map->hud.dead_face);
	find_texture_by_name(textures, "textures/hud/faces/badass.bmp",
						 &map->hud.badass_face);
	find_texture_by_name(textures, "textures/hud/faces/sehr_happy.bmp",
						 &map->hud.sehr_happy_face);
	find_texture_by_name(textures, "textures/hud/faces/hurt.bmp",
						 &map->hud.hurt_face);
	find_texture_by_name(textures, "textures/weapons/dwa.bmp",
						 &map->melee_sprite);
	find_texture_by_name(textures, "textures/weapons/gun_1.bmp",
						 &map->gun_sprites[0]);
	find_texture_by_name(textures, "textures/weapons/gun_2.bmp",
						 &map->gun_sprites[1]);
	find_texture_by_name(textures, "textures/weapons/gun_3.bmp",
						 &map->gun_sprites[2]);
	find_texture_by_name(textures, "textures/weapons/gun_firing.bmp",
						 &map->gun_sprites[3]);
	find_texture_by_name(textures, "textures/weapons/gun_cooldown.bmp",
						 &map->gun_sprites[4]);
	find_texture_by_name(textures, "textures/weapons/shotgun_1.bmp",
						 &map->shotgun_sprites[0]);
	find_texture_by_name(textures, "textures/weapons/shotgun_cooldown.bmp",
						 &map->shotgun_sprites[1]);
	find_texture_by_name(textures, "textures/weapons/shotgun_firing.bmp",
						 &map->shotgun_sprites[2]);
	find_texture_by_name(textures, "textures/weapons/blackhole_destroyer.bmp",
						 &map->vacuum_sprite);
	map->daytime = e_true;
	map->spawn.x = 1;
	map->spawn.y = 1;
...
t_textures	*load_textures(void)
{
	...
	add_bitmap_file_to_textures(textures,
								"textures/sprites/enemy_front_firing_0.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/sprites/enemy_front_firing_1.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/sprites/enemy_front_firing_2.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/sprites/enemy_front_firing_3.bmp");
	...
	add_bitmap_file_to_textures(textures,
								"textures/weapons/shotgun_cooldown.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/weapons/shotgun_firing.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/weapons/blackhole_destroyer.bmp");
	...
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_1.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_2.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_3.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_4.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_5.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_6.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_7.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_8.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_9.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_10.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_11.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_12.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_13.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_14.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_15.bmp");
	add_bitmap_file_to_textures(textures,
								"textures/explosions/explosion_16.bmp");
	return (textures);
}
